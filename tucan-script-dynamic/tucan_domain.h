...
typedef void (__cdecl* tucan_load_plugin_fun)(tucan_script::tucan_module* module_ptr);
...
extern "C++"
{
	...
	TUCAN_EXPORT void tucan_load_plugin(tucan_script::tucan_module* module_ptr, LPCSTR filename);
}
